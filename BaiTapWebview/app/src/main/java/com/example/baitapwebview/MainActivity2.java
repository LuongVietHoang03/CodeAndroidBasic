            ...
            btn_add.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(hoten.isEmpty() ||email.isEmpty()||sodienthoai.isEmpty()||gioithieu.isEmpty()){
                        Toast.makeText(MainActivity2.this, "Không được bỏ trống", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    editor.commit();
                    Toast.makeText(MainActivity2.this, "Thêm mới thành công", Toast.LENGTH_SHORT).show();
                    finish();
                }
